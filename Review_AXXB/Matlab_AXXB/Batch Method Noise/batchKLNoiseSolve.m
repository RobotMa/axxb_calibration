function [X_solved, SigX_solved, COST, MeanA, MeanB, SigA, SigB]=batchKLNoiseSolve(A,B,X_initial, SigX_initial)
...
for k=1:2000
    ...
    COST_temp1=KLcost(s1, phi(k), SigX_solved(:,:,k), R_nanb, MeanA, SigA, thetaa, na, va, MeanB, SigB, thetab, nb, vb);
    COST_temp2=KLcost(s1, phi(k), SigX_solved(:,:,k), R_nanb, MeanA, SigA, thetaa, na, va, MeanB, SigB, thetab, nb, vb);
    ...
    COST_temp1=KLcost(s(k), phi1, SigX_solved(:,:,k), R_nanb, MeanA, SigA, thetaa, na, va, MeanB, SigB, thetab, nb, vb);
    COST_temp2=KLcost(s(k), phi2, SigX_solved(:,:,k), R_nanb, MeanA, SigA, thetaa, na, va, MeanB, SigB, thetab, nb, vb);
    ...
    for i=1:21
        ...
        COST_temp1=KLcost(s(k), phi(k), SigX1, R_nanb, MeanA, SigA, thetaa, na, va, MeanB, SigB, thetab, nb, vb);
        COST_temp2=KLcost(s(k), phi(k), SigX2, R_nanb, MeanA, SigA, thetaa, na, va, MeanB, SigB, thetab, nb, vb);
