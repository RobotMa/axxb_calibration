...
xlabel('noise_{std}/model_{std}. Meaning: 0.02 = 2%')
ylabel('Error')
title('Rotation error between the true X and the solved X')
...
ylabel('Error')
title('Translation error between the true X and the solved X')
