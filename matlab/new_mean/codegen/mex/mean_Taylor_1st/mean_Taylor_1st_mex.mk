...
MAKEFILE = mean_Taylor_1st_mex.mk

include mean_Taylor_1st_mex.mki


SRC_FILES =  \
	mean_Taylor_1st_data.c \
	mean_Taylor_1st_initialize.c \
	...
	mean_Taylor_1st_emxutil.c \
	_coder_mean_Taylor_1st_info.c

MEX_FILE_NAME_WO_EXT = mean_Taylor_1st_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_Taylor_1st"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_Taylor_1st/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_1st/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_1st/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_1st/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
