...
static emlrtRSInfo i_emlrtRSI = { 24, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};

static emlrtRSInfo j_emlrtRSI = { 21, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo k_emlrtRSI = { 27, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo l_emlrtRSI = { 31, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo m_emlrtRSI = { 32, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo o_emlrtRSI = { 58, "svd",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/svd.m" };

static emlrtRSInfo r_emlrtRSI = { 421, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo bb_emlrtRSI = { 247, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo cb_emlrtRSI = { 236, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo mb_emlrtRSI = { 1, "xscal",
  "/usr/local/MATLAB/R2015a/toolbox/coder/coder/+coder/+internal/+blas/xscal.p"
};

static emlrtRSInfo nb_emlrtRSI = { 1, "xscal",
  "/usr/local/MATLAB/R2015a/toolbox/coder/coder/+coder/+internal/+refblas/xscal.p"
};

static emlrtRSInfo ob_emlrtRSI = { 28, "eml_xscal",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/blas/eml_xscal.m" };

static emlrtRTEInfo d_emlrtRTEI = { 11, 25, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};

static emlrtECInfo c_emlrtECI = { 2, 19, 13, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};

static emlrtBCInfo c_emlrtBCI = { -1, -1, 19, 25, "X", "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m",
  0 };

static emlrtRTEInfo g_emlrtRTEI = { 18, 1, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};
                     ...
                     [16])
{
  ...
  real_T Rx[9];
  real_T x;
  static const int8_T iv7[4] = { 0, 0, 0, 1 };
  ...
  while (i <= (int32_T)n - 1) {
    ...
    if ((uint32_T)i3 > u0) {
      ...
      if (i3 < i4) {
        ...
        i5 = emlrtDynamicBoundsCheckR2012b(i3, 1, i4, &c_emlrtBCI, sp);
      }
      ...
      if ((k >= 1) && (k < i4)) {
        ...
        i4 = emlrtDynamicBoundsCheckR2012b(k, 1, i4, &c_emlrtBCI, sp);
      }
    }
    ...
    for (k = 0; k < loop_ub; k++) {
      for (i6 = 0; i6 < 4; i6++) {
        b_X->data[i6 + b_X->size[0] * k] = X->data[i6 + X->size[0] * (i3 + k)];
      }
    }
    ...
    if ((4 != d_X[0]) || (4 != d_X[1])) {
      emlrtSizeEqCheckNDR2012b(iv6, d_X, &c_emlrtECI, sp);
    }
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      for (k = 0; k < 4; k++) {
        c_X->data[k + c_X->size[0] * i4] = X->data[k + X->size[0] * (i3 + i4)];
      }
    }

    for (i3 = 0; i3 < 4; i3++) {
      for (i4 = 0; i4 < 4; i4++) {
        M_hat[i4 + (i3 << 2)] += c_X->data[i4 + (i3 << 2)];
      }
    }
