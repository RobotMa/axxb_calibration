...
MAKEFILE = mean_Taylor_2nd_mex.mk

include mean_Taylor_2nd_mex.mki


SRC_FILES =  \
	mean_Taylor_2nd_mexutil.c \
	mean_Taylor_2nd_data.c \
	mean_Taylor_2nd_initialize.c \
	mean_Taylor_2nd_terminate.c \
	mean_Taylor_2nd.c \
	mean_Taylor_1st.c \
	mrdivide.c \
	...
	_coder_mean_Taylor_2nd_mex.c \
	mean_Taylor_2nd_emxutil.c \
	_coder_mean_Taylor_2nd_info.c

MEX_FILE_NAME_WO_EXT = mean_Taylor_2nd_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_Taylor_2nd"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_Taylor_2nd/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_2nd/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_2nd/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_2nd/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
