 ...
 *
 * _coder_mean_double_convl_2nd_api.h
 *
...
extern void mean_double_convl_2nd_api(const mxArray * const prhs[8], const
  mxArray *plhs[1]);

#endif

/* End of code generation (_coder_mean_double_convl_2nd_api.h) */
