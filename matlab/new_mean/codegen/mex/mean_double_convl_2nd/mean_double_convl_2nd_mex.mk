...
MAKEFILE = mean_double_convl_2nd_mex.mk

include mean_double_convl_2nd_mex.mki
...
MEX_FILE_NAME_WO_EXT = mean_double_convl_2nd_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_double_convl_2nd"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_double_convl_2nd/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_double_convl_2nd/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_double_convl_2nd/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_double_convl_2nd/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
