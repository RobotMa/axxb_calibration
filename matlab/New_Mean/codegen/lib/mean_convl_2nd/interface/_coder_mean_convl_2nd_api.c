 ...
 * File: _coder_mean_convl_2nd_api.c
 *
...
static int8_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
 ...
 * Return Type  : void
 */
void mean_convl_2nd_api(const mxArray *prhs[5], const mxArray *plhs[1])
{
  real_T (*M12_f)[16];
  emxArray_real_T *X1;
  emxArray_real_T *X2;
  ...
  emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "X2", X2);
  s1 = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "s1");
  s2 = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "s2");
  n_search = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "n_search");

  /* Invoke the target function */
  mean_convl_2nd(X1, X2, s1, s2, n_search, *M12_f);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*M12_f);
 ...
 * Return Type  : void
 */
void mean_convl_2nd_atexit(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void mean_convl_2nd_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void mean_convl_2nd_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_mean_convl_2nd_api.c
 *
 * [EOF]
 */
