...
static emlrtRSInfo mb_emlrtRSI = { 51, "expm",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtRSInfo nb_emlrtRSI = { 61, "expm",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtRSInfo ob_emlrtRSI = { 174, "expm",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/expm.m" };

static emlrtRSInfo pb_emlrtRSI = { 1, "mldivide",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/ops/mldivide.p" };

static emlrtRSInfo qb_emlrtRSI = { 42, "eml_lusolve",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/eml_lusolve.m" };

static emlrtRSInfo rb_emlrtRSI = { 92, "eml_lusolve",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/eml_lusolve.m" };

static emlrtRSInfo sb_emlrtRSI = { 90, "eml_lusolve",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/eml_lusolve.m" };

static emlrtRSInfo tb_emlrtRSI = { 130, "eml_lusolve",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/eml_lusolve.m" };

static emlrtRTEInfo j_emlrtRTEI = { 62, 5, "expm",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/expm.m" };
...
void expm(const emlrtStack *sp, real_T A[16], real_T F[16])
{
  ...
  if (normA <= 5.3719203511481517) {
    ...
    while ((!exitg1) && (eint < 5)) {
      if (normA <= theta[eint]) {
        st.site = &mb_emlrtRSI;
        PadeApproximantOfDegree(&st, A, iv18[eint], F);
        exitg1 = true;
      } else {
        eint++;
      }
    ...
    for (j = 0; j < (int32_T)s; j++) {
      for (eint = 0; eint < 4; eint++) {
        for (i19 = 0; i19 < 4; i19++) {
          b_F[eint + (i19 << 2)] = 0.0;
          for (i20 = 0; i20 < 4; i20++) {
            b_F[eint + (i19 << 2)] += F[eint + (i20 << 2)] * F[i20 + (i19 << 2)];
          }
        }
      }
