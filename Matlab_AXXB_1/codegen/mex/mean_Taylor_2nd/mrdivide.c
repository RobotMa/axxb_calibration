...
static emlrtRSInfo qc_emlrtRSI = { 1, "mrdivide",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/ops/mrdivide.p" };

static emlrtRTEInfo k_emlrtRTEI = { 1, 1, "mrdivide",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/ops/mrdivide.p" };
...
void mrdivide(const emlrtStack *sp, const emxArray_real_T *A, const real_T B[16],
              real_T y_data[], int32_T y_size[2])
{
  ...
  if (4 == A->size[1]) {
    ...
    emlrtErrorWithMessageIdR2012b(sp, &k_emlrtRTEI, "Coder:MATLAB:dimagree", 0);
  }
