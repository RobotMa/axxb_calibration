...
static void main_mean_Taylor_2nd_adv();
...
static void main_mean_Taylor_2nd_adv()
{
  ...
  // Initialize function 'mean_Taylor_2nd_adv' input arguments.
  // Initialize function input argument 'X'.
  X = argInit_4xUnbounded_real_T();

  // Call the entry-point 'mean_Taylor_2nd_adv'.
  mean_Taylor_2nd_adv(X, argInit_real_T(), argInit_int16_T(), MX);
