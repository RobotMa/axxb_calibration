...
#include "mean_convl_2nd_emxAPI.h"
...
static void main_mean_convl_2nd();
...
static emxArray_real_T *argInit_4xUnbounded_real_T()
{
  ...
  result = emxCreateND_real_T(2, *(int (*)[2])&iv14[0]);
...
static void main_mean_convl_2nd()
{
  ...
  // Initialize function 'mean_convl_2nd' input arguments.
  // Initialize function input argument 'X1'.
  X1 = argInit_4xUnbounded_real_T();

  // Initialize function input argument 'X2'.
  X2 = argInit_4xUnbounded_real_T();

  // Call the entry-point 'mean_convl_2nd'.
  mean_convl_2nd(X1, X2, argInit_int8_T(), argInit_int8_T(), argInit_int16_T(),
                 M12_f);
