...
static emlrtRSInfo v_emlrtRSI = { 21, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo w_emlrtRSI = { 25, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo x_emlrtRSI = { 29, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo y_emlrtRSI = { 30, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo bb_emlrtRSI = { 58, "svd",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/svd.m" };

static emlrtRSInfo eb_emlrtRSI = { 421, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo nb_emlrtRSI = { 247, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo ob_emlrtRSI = { 236, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo yb_emlrtRSI = { 1, "xscal",
...
static emlrtRSInfo bc_emlrtRSI = { 28, "eml_xscal",
...
void orthog(const emlrtStack *sp, const real_T M_hat[16], real_T T[16])
{
  ...
  int32_T i16;
  real_T x;
  static const int8_T iv14[4] = { 0, 0, 0, 1 };
  ...
  for (k = 0; k < 3; k++) {
    for (i15 = 0; i15 < 3; i15++) {
      Rx[k + 3 * i15] = 0.0;
      for (i16 = 0; i16 < 3; i16++) {
        Rx[k + 3 * i15] += V[k + 3 * i16] * U[i15 + 3 * i16];
      }
    }
  }
