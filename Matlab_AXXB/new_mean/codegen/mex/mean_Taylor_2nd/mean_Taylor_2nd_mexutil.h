 ...
 *
 * mean_Taylor_2nd_mexutil.h
 *
 * Code generation for function 'mean_Taylor_2nd_mexutil'
 *
 */

#ifndef __MEAN_TAYLOR_2ND_MEXUTIL_H__
#define __MEAN_TAYLOR_2ND_MEXUTIL_H__
...
/* End of code generation (mean_Taylor_2nd_mexutil.h) */
