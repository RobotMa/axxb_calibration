...
MAKEFILE = mean_Taylor_2nd_adv_mex.mk

include mean_Taylor_2nd_adv_mex.mki


SRC_FILES =  \
	mean_Taylor_2nd_adv_mexutil.c \
	mean_Taylor_2nd_adv_data.c \
	mean_Taylor_2nd_adv_initialize.c \
	...
	mean_Taylor_2nd_adv_emxutil.c \
	_coder_mean_Taylor_2nd_adv_info.c

MEX_FILE_NAME_WO_EXT = mean_Taylor_2nd_adv_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_Taylor_2nd_adv"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mean_Taylor_2nd_adv/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_2nd_adv/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_2nd_adv/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mean_Taylor_2nd_adv/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
