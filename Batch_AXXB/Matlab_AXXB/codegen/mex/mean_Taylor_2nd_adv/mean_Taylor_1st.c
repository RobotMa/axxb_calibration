...
static emlrtRSInfo k_emlrtRSI = { 24, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};

static emlrtRSInfo l_emlrtRSI = { 21, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo m_emlrtRSI = { 26, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo n_emlrtRSI = { 30, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo o_emlrtRSI = { 31, "orthog",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/orthog.m" };

static emlrtRSInfo q_emlrtRSI = { 58, "svd",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/matfun/svd.m" };

static emlrtRSInfo t_emlrtRSI = { 421, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo db_emlrtRSI = { 247, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo eb_emlrtRSI = { 236, "eml_matlab_zsvdc",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"
};

static emlrtRSInfo ob_emlrtRSI = { 1, "xscal",
  "/usr/local/MATLAB/R2015a/toolbox/coder/coder/+coder/+internal/+blas/xscal.p"
};

static emlrtRSInfo pb_emlrtRSI = { 1, "xscal",
  "/usr/local/MATLAB/R2015a/toolbox/coder/coder/+coder/+internal/+refblas/xscal.p"
};

static emlrtRSInfo qb_emlrtRSI = { 28, "eml_xscal",
  "/usr/local/MATLAB/R2015a/toolbox/eml/lib/matlab/eml/blas/eml_xscal.m" };

static emlrtRTEInfo f_emlrtRTEI = { 11, 25, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};

static emlrtECInfo d_emlrtECI = { 2, 19, 13, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};

static emlrtBCInfo d_emlrtBCI = { -1, -1, 19, 25, "X", "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m",
  0 };

static emlrtRTEInfo j_emlrtRTEI = { 18, 1, "mean_Taylor_1st",
  "/home/roma/Dropbox/2015Spring/AXXB Journal/Batch_AXXB/Matlab_AXXB/mean_Taylor_1st.m"
};
                     ...
                     [16])
{
  ...
  emlrtForLoopVectorCheckR2012b(1.0, 1.0, n, mxDOUBLE_CLASS, (int32_T)n,
    &j_emlrtRTEI, sp);
  i = 0;
  emxInit_real_T(sp, &b_X, 2, &f_emlrtRTEI, true);
  ...
  while (i <= (int32_T)n - 1) {
    ...
    if ((uint32_T)i5 > u0) {
      ...
      if (i5 < i6) {
        ...
        i7 = emlrtDynamicBoundsCheckR2012b(i5, 1, i6, &d_emlrtBCI, sp);
      }
      ...
      if ((k >= 1) && (k < i6)) {
        ...
        i6 = emlrtDynamicBoundsCheckR2012b(k, 1, i6, &d_emlrtBCI, sp);
      }
    }
    ...
    for (k = 0; k < loop_ub; k++) {
      for (i8 = 0; i8 < 4; i8++) {
        b_X->data[i8 + b_X->size[0] * k] = X->data[i8 + X->size[0] * (i5 + k)];
      }
    }
    ...
    if ((4 != d_X[0]) || (4 != d_X[1])) {
      emlrtSizeEqCheckNDR2012b(iv7, d_X, &d_emlrtECI, sp);
    }
    ...
    for (i6 = 0; i6 < loop_ub; i6++) {
      for (k = 0; k < 4; k++) {
        c_X->data[k + c_X->size[0] * i6] = X->data[k + X->size[0] * (i5 + i6)];
      }
    }

    for (i5 = 0; i5 < 4; i5++) {
      for (i6 = 0; i6 < 4; i6++) {
        M_hat[i6 + (i5 << 2)] += c_X->data[i6 + (i5 << 2)];
      }
    }
  ...
  for (i5 = 0; i5 < 3; i5++) {
    for (i6 = 0; i6 < 3; i6++) {
      M_1[i6 + (i5 << 2)] = Rx[i6 + 3 * i5];
    }
  }

  for (i5 = 0; i5 < 3; i5++) {
    M_1[12 + i5] = M_hat[12 + i5];
  }
