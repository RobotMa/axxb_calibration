...
MAKEFILE = distibutionPropsMex_mex.mk

include distibutionPropsMex_mex.mki


SRC_FILES =  \
	distibutionPropsMex_data.c \
	...
	distibutionPropsMex_emxutil.c \
	_coder_distibutionPropsMex_info.c

MEX_FILE_NAME_WO_EXT = distibutionPropsMex_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/distibutionPropsMex"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/distibutionPropsMex/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/distibutionPropsMex/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/distibutionPropsMex/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/distibutionPropsMex/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
