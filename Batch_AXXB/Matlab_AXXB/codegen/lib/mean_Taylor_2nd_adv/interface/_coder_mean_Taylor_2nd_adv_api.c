 ...
 * File: _coder_mean_Taylor_2nd_adv_api.c
 *
 ...
 * Return Type  : void
 */
void mean_Taylor_2nd_adv_api(const mxArray *prhs[3], const mxArray *plhs[1])
{
  real_T (*MX)[16];
  emxArray_real_T *X;
  real_T noise;
  ...
  mean_Taylor_2nd_adv(X, noise, num, *MX);
...
void mean_Taylor_2nd_adv_atexit(void)
{
  ...
  mean_Taylor_2nd_adv_xil_terminate();
}
 ...
 * Return Type  : void
 */
void mean_Taylor_2nd_adv_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_mean_Taylor_2nd_adv_api.c
 *
 * [EOF]
 */
